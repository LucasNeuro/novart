        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm font-medium text-on-surface-variant">
              Dados em cache com TanStack Query (atualizacao ao focar a janela ou ao tocar em
              Recarregar).
            </p>
          </div>
          <button
        ...
        {!isPending && !isError && leads.length === 0 && (
          <div className="mt-8 border-2 border-dashed border-outline-variant bg-surface/50 px-6 py-10 text-center">
            ...
            <p className="mt-2 text-sm text-on-surface-variant">
              ...
              desenvolvimento pode inserir um registo de teste pelo SQL Editor ou esperar integracoes
              de formulario/canal.
            </p>
          </div>
        )}
